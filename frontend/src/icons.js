/* ============================================================
   Lucide icon paths (ISC License — https://lucide.dev)
   Inner SVG markup for the icons used across the UI.
   Rendered by Icon.svelte inside a 24x24 stroke SVG.
   Only the icons actually used are included here.
   ============================================================ */
...
export const icons = {
  ...
  // --- Simulator model categories (utils/simulator.js CATEGORY_ICONS) ---
